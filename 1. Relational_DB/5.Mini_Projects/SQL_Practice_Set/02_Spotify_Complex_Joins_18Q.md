...
SELECT
  ar.name,
  COUNT(r.album_id) AS album_count
FROM
  artists ar
...
FROM
  ...
  JOIN artists ar ON r.artist_id = ar.id
WHERE
  al.release_date BETWEEN '2020-01-01' AND '2020-12-31';
